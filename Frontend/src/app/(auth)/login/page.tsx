  ...
  const onValid = async (v: LoginValues) => {
    ...
    try {
      ...
      if (isUnverifiedError(err)) {
        router.push(
          `/verify-email?email=${encodeURIComponent(v.email.trim())}`,
        );
        return;
      }
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          >
            <div>
              ...
              <div className="group relative">
                ...
                <input
                  type="email"
                  dir="ltr"
                  placeholder="example@avicena.com"
            ...
            {apiError && (
              <p className="rounded-lg bg-error-container p-3 text-sm text-on-error-container">
                {apiError}
              </p>
            )}
            ...
            {/* <button
              type="button"
              onClick={() =>
                setApiError("تسجيل الدخول عبر جوجل غير مفعّل حالياً")
              }
              ...
              <GoogleLogin
                ...
                onSuccess={async (credentialResponse) => {
                  ...
                  try {
                    ...
                    setApiError(
                      getErrorMessage(error, "فشل تسجيل الدخول عبر جوجل"),
                    );
                  }
                }}
                onError={() => {
                  setApiError("فشل التسجيل عبر جوجل");
                }}
              />
            </div>
          </form>
